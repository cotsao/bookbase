        ...
        return (
            <div className="card showcase-card" key={idx}>
                <article className="content showcase-content">
                    <Link to={book.key}>
                        <img  className="content-img book-img showcase-img" src={imgUrl} alt="N/A" />
                    </Link>
                ...
                {dropdown && (idx===index)&& <AddToReadList bookKey={book.key} mouseLeave={toggleDropdown} index={idx} />}
            </div>
        )
    })
