            ...
            <nav className="nav-container">
                ...
                <ul className="nav-flex">
                    ...
                    <div className="nav-right">
                        <img style={{ maxWidth: 20, maxHeight: 20 }} src="https://w7.pngwing.com/pngs/456/948/png-transparent-computer-icons-desktop-web-search-engine-wordpress-com-search-icon-search-logo-website-circle-wordpresscom.png" alt="" />
                        <div>
                        <input
